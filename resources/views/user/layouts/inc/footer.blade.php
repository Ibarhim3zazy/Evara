                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        <div class="col flex-horizontal-center">
                            <img class="icon-email" src="{{ asset('user/assets') }}/imgs/theme/icons/icon-email.svg"
                                alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        <div class="logo logo-width-1 wow fadeIn animated">
                            <a href="index.html"><img src="{{ asset('user/assets') }}/imgs/theme/logo.svg"
                                    alt="logo"></a>
                        </div>
                        ...
                        <div class="col-md-8 col-lg-12">
                            ...
                            <div class="download-app wow fadeIn animated">
                                <a href="#" class="hover-up mb-sm-4 mb-lg-0"><img class="active"
                                        src="{{ asset('user/assets') }}/imgs/theme/app-store.jpg" alt=""></a>
                                <a href="#" class="hover-up"><img
                                        src="{{ asset('user/assets') }}/imgs/theme/google-play.jpg" alt=""></a>
                            </div>
                        </div>
