                        ...
                        <ul>
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="{{ asset('user/assets') }}/imgs/theme/flag-fr.png"
                                                alt="">Français</a></li>
                                    <li><a href="#"><img src="{{ asset('user/assets') }}/imgs/theme/flag-dt.png"
                                                alt="">Deutsch</a></li>
                                    <li><a href="#"><img src="{{ asset('user/assets') }}/imgs/theme/flag-ru.png"
                                                alt="">Pусский</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="header-action-2">
                        ...
                        <div class="header-action-icon-2">
                            <a class="mini-cart-icon" href="shop-cart.html">
                                <img alt="Evara" src="{{ asset('user/assets') }}/imgs/theme/icons/icon-cart.svg">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara"
                                                    src="{{ asset('user/assets') }}/imgs/shop/thumbnail-1.jpg"></a>
                                        </div>
                                        <div class="shopping-cart-title">
