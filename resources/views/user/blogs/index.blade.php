...
<section class="content-main">
    <div class="content-header">
        ...
        <div>
            ...
            <a href="{{ route('blogs.create') }}" class="btn btn-primary btn-sm rounded">Create new</a>
        </div>
    </div>
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="alert-success alert">{{ session('blogUpdateStatus') }}</div>
            @endsession
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img width="50" src="{{ Storage::url('images/blogs/'.$blog->image) }}" alt="">
                        </td>
                        <td>
                            <a href="{{ route('blogs.edit', $blog->id) }}" class="btn btn-sm btn-secondary"
                                style="padding: 5px 20px;">Edit</a>
                            <a href="#" data-bs-toggle="modal" data-url="{{ route('blogs.destroy', $blog->id) }}"
